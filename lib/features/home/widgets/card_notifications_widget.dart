...
import 'package:teacher_app/features/child_management/widgets/class_transfer_action_sheet.dart';
...
class _CardNotificationsWidgetState extends State<CardNotificationsWidget> {
  ...
  Future<void> _loadIds() async {
    ...
    if (mounted && savedClassId != null && savedClassId.isNotEmpty) {
      ...
      // LoadHomeDataEvent قبلاً LoadSessionEvent صدا زده؛ فقط اگر هنوز لود نشده و در حال لود نیست
      final currentState = context.read<HomeBloc>().state;
      if (!_hasRequestedSession &&
          currentState.session == null &&
          !currentState.isLoadingSession) {
